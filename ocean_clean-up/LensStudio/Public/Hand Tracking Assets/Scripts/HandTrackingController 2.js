...
//@input SceneObject boneIndicator
//@input SceneObject boneIndicatorThumb
...
function Bone(jointa, jointb) {
    ...
    this.object = null;
    // ----------------------------------------------------------------------------------------
    // [author: Martina Kessler]: changed this to make color the bones of the thumb differently
    if (script.showBones && script.boneIndicator && script.boneIndicatorThumb) {
        if (jointa.name.includes('thumb') || jointb.name.includes('thumb')){
            this.object = script.getSceneObject().copyWholeHierarchy(script.boneIndicatorThumb);
        }
        else{
...
function initialize() {
    ...
    // ------------------------------------------------------------------------------
    // [author: Martina Kessler]: added trigger response to show bones for dance game
    script.showBones = false;
    global.behaviorSystem.addCustomTriggerResponse("dance_game_start", onDanceGameStart);
    // ------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------
// [author: Martina Kessler]: added trigger response to show bones for dance game
function onDanceGameStart(){
    script.showBones = true;
    bones = [];
    initializeBones();
}
// ------------------------------------------------------------------------------
